...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/sebastes.png" title="sebastes" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/physonect.png" title="physonect" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/copepod_calanoid.png" title="calanoid" class="img-fluid rounded z-depth-1" %}
  </div>
</div>

My aims are: 
- understand the abundance and distribution of important zooplankton taxa in relation to low oxygen.
- explore the indirect effects of predation pressure and prey availability for larval fishes under different degrees of hypoxic stress
